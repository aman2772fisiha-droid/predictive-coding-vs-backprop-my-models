...
def infer_hidden_manual(
    ...
    for step in range(steps + 1):
        ...
        h1.clamp_(-config.hidden_clip, config.hidden_clip)
        h2.clamp_(-config.hidden_clip, config.hidden_clip)
        h3.clamp_(-config.hidden_clip, config.hidden_clip)
        h4.clamp_(-config.hidden_clip, config.hidden_clip)
